...
Next: **Stage 7**, define playtesting, telemetry, tuning and balance using the accepted thesis, behaviour, prototype/commitment and [content/handoff](../contracts/content-and-handoffs.md) contracts. Stages 1, 1A, 1B and 2–6 are complete; implemented capability proofs remain unperformed.
