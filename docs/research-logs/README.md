...
Current: **Stage 12**. Precision Platformer P1–P5 and Tactical Turn-based P1–P2 research are complete; Tactical Turn-based P3 is next. Stages 1, 1A, 1B and 2–11 are complete. Implemented capability proofs and clean installation remain unperformed.
