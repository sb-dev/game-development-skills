...
Next: **Stage 6**, model levels, worlds, content and cross-domain handoffs using the accepted thesis, behaviour and [prototype/commitment](../contracts/prototype-and-commitment.md) contracts. Stages 1, 1A, 1B and 2–5 are complete; implemented capability proofs remain unperformed.
